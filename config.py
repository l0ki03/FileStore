...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6256756166:AAG9xfrFm5KGw4mUxfciZxTbDpYQceYCE78")
#Your API ID from my.telegram.org
APP_ID = int(os.environ.get("APP_ID", "22167428"))
#Your API Hash from my.telegram.org
API_HASH = os.environ.get("API_HASH", "f936053286f724b8a1df69729b28a6af")
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002685036831"))
# NAMA OWNER
...
#Database
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://dakot79167:lK9a3W12mvkKClQ7@cluster0.qcqlx.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0
")
...
FORCE_SUB_CHANNEL1 = int(os.environ.get("FORCE_SUB_CHANNEL1", "-1002685036831"))
#put 0 to disable
